# DexGuard, version 9.4.14
-injars /Volumes/DATA/DexGuard/applicaiton/demo-apps/academic_ponpes/app/build/outputs/apk/release/app-release.apk
-outjars /Volumes/DATA/DexGuard/applicaiton/demo-apps/academic_ponpes/app/build/outputs/apk/release/app-release-protected.apk

-libraryjars /Users/nikki/Library/Android/sdk/platforms/android-33/android.jar


-printmaindexlist /Volumes/DATA/DexGuard/applicaiton/demo-apps/academic_ponpes/app/build/outputs/dexguard/mapping/apk/release/maindexlist.txt
-dontcompress **.3G2,**.3GP,**.3GPP,**.3GPP2,**.3g2,**.3gp,**.3gpp,**.3gpp2,**.AAC,**.AMR,**.APK,**.AWB,**.GIF,**.IMY,**.JAR,**.JET,**.JPEG,**.JPG,**.M4A,**.M4V,**.MID,**.MIDI,**.MKV,**.MOV,**.MP2,**.MP3,**.MP4,**.MPEG,**.MPG,**.OGG,**.PNG,**.RTTTL,**.SMF,**.TFLITE,**.WAV,**.WEBM,**.WEBP,**.WMA,**.WMV,**.XMF,**.ZIP,**.aac,**.amr,**.apk,**.awb,**.gif,**.imy,**.jar,**.jet,**.jpeg,**.jpg,**.m4a,**.m4v,**.mid,**.midi,**.mkv,**.mov,**.mp2,**.mp3,**.mp4,**.mpeg,**.mpg,**.ogg,**.png,**.rtttl,**.smf,**.tflite,**.wav,**.webm,**.webp,**.wma,**.wmv,**.xmf,**.zip,META-INF/androidx.activity_activity-ktx.version,META-INF/androidx.activity_activity.version,META-INF/androidx.annotation_annotation-experimental.version,META-INF/androidx.appcompat_appcompat-resources.version,META-INF/androidx.appcompat_appcompat.version,META-INF/androidx.arch.core_core-runtime.version,META-INF/androidx.asynclayoutinflater_asynclayoutinflater.version,META-INF/androidx.browser_browser.version,META-INF/androidx.cardview_cardview.version,META-INF/androidx.coordinatorlayout_coordinatorlayout.version,META-INF/androidx.core_core-ktx.version,META-INF/androidx.core_core.version,META-INF/androidx.cursoradapter_cursoradapter.version,META-INF/androidx.customview_customview.version,META-INF/androidx.databinding_viewbinding.version,META-INF/androidx.documentfile_documentfile.version,META-INF/androidx.drawerlayout_drawerlayout.version,META-INF/androidx.dynamicanimation_dynamicanimation.version,META-INF/androidx.emoji2_emoji2-views-helper.version,META-INF/androidx.emoji2_emoji2.version,META-INF/androidx.exifinterface_exifinterface.version,META-INF/androidx.fragment_fragment-ktx.version,META-INF/androidx.fragment_fragment.version,META-INF/androidx.interpolator_interpolator.version,META-INF/androidx.legacy_legacy-support-core-ui.version,META-INF/androidx.legacy_legacy-support-core-utils.version,META-INF/androidx.legacy_legacy-support-v4.version,META-INF/androidx.lifecycle_lifecycle-livedata-core-ktx.version,META-INF/androidx.lifecycle_lifecycle-livedata-core.version,META-INF/androidx.lifecycle_lifecycle-livedata-ktx.version,META-INF/androidx.lifecycle_lifecycle-livedata.version,META-INF/androidx.lifecycle_lifecycle-process.version,META-INF/androidx.lifecycle_lifecycle-runtime-ktx.version,META-INF/androidx.lifecycle_lifecycle-runtime.version,META-INF/androidx.lifecycle_lifecycle-viewmodel-ktx.version,META-INF/androidx.lifecycle_lifecycle-viewmodel-savedstate.version,META-INF/androidx.lifecycle_lifecycle-viewmodel.version,META-INF/androidx.loader_loader.version,META-INF/androidx.localbroadcastmanager_localbroadcastmanager.version,META-INF/androidx.media_media.version,META-INF/androidx.navigation_navigation-common-ktx.version,META-INF/androidx.navigation_navigation-common.version,META-INF/androidx.navigation_nav
encryptclasses class com.google.android.gms.internal.firebase-auth-api.zzoh

-encryptclasses class com.google.android.gms.internal.firebase-auth-api.zzacs

-encryptclasses class com.google.android.gms.measurement.internal.zzln

-encryptclasses class com.facebook.AccessTokenManager$Companion

-encryptclasses class com.google.firebase.installations.local.IidStore

-encryptclasses class com.facebook.internal.security.CertificateUtil

-encryptclasses class com.facebook.appevents.internal.HashUtils

-encryptclasses class com.facebook.appevents.AppEvent$Companion

-encryptclasses class com.facebook.AccessTokenManager$Companion

-encryptclasses class com.facebook.AccessTokenManager$FacebookRefreshTokenInfo

-encryptclasses class com.facebook.AccessTokenManager$InstagramRefreshTokenInfo

-encryptclasses class com.facebook.AccessTokenManager$RefreshResult

-encryptclasses class com.facebook.AccessTokenManager$RefreshTokenInfo

-encryptclasses class com.facebook.AccessTokenManager

-encryptclasses class com.facebook.login.DeviceAuthDialog

-encryptclasses class com.google.android.gms.internal.measurement.zznl

-encryptclasses class com.google.android.gms.ads.identifier.zza

-encryptclasses class com.facebook.internal.Utility

-encryptclasses class com.facebook.FacebookSdk

-encryptclasses class com.google.android.gms.auth.api.signin.GoogleSignInOptions

-encryptclasses class com.facebook.internal.Validate

-encryptclasses class androidx.fragment.app.Fragment

-encryptclasses class com.google.android.gms.internal.firebase-auth-api.zzna

-encryptclasses class androidx.core.view.WindowInsetsCompat$Impl20

-encryptclasses class com.google.android.gms.internal.firebase-auth-api.zzaex

-encryptclasses class com.google.android.gms.internal.measurement.zzmx

-encryptclasses class com.google.android.gms.internal.firebase-auth-api.zzafx

-encryptclasses class com.google.android.gms.internal.measurement.zznu

-encryptclasses class com.google.firebase.concurrent.SequentialExecutor$QueueWorker

-encryptclasses class com.google.android.gms.internal.firebase-auth-api.zzaft

-encryptclasses class androidx.**

-encryptclasses class okhttp3.**

-encryptclasses class com.google.android.gms.**

-encryptclasses class retrofit2.**

-encryptclasses class okio.**

-encryptclasses class androidx.fragment.app.Fragment

-encryptclasses class androidx.fragment.app.Fragment$1

-encryptclasses class androidx.fragment.app.Fragment$2

-encryptclasses class androidx.fragment.app.Fragment$3

-encryptclasses class androidx.fragment.app.Fragment$4

-encryptclasses class androidx.fragment.app.Fragment$AnimationInfo

-encryptclasses class androidx.fragment.app.Fragment$Api19Impl

-encryptclasses class androidx.fragment.app.Fragment$InstantiationException

-encryptclasses class androidx.fragment.app.Fragment$OnPreAttachedListener

-encryptclasses class androidx.concurrent.futures.AbstractResolvableFuture

-encryptclasses class androidx.concurrent.futures.AbstractResolvableFuture$1

-encryptclasses class androidx.concurrent.futures.AbstractResolvableFuture$AtomicHelper

-encryptclasses class androidx.concurrent.futures.AbstractResolvableFuture$Cancellation

-encryptclasses class androidx.concurrent.futures.AbstractResolvableFuture$Failure

-encryptclasses class androidx.concurrent.futures.AbstractResolvableFuture$Failure$1

-encryptclasses class androidx.concurrent.futures.AbstractResolvableFuture$Listener

-encryptclasses class androidx.concurrent.futures.AbstractResolvableFuture$SafeAtomicHelper

-encryptclasses class androidx.concurrent.futures.AbstractResolvableFuture$SetFuture

-encryptclasses class androidx.concurrent.futures.AbstractResolvableFuture$SynchronizedHelper

-encryptclasses class androidx.concurrent.futures.AbstractResolvableFuture$Waiter
...
-encryptstrings class com.sourcey.materiallogindemo.core.retrofit.RetrofitClient {
    final java.lang.String baseUrl;}
-adaptclassstrings io.fabric.sdk.android.services.common.AdvertisingInfoReflectionStrategy,com.mopub.common.GpsHelper,com.localytics.android.DatapointHelper,org.apache.commons.logging.LogFactory
...
-keep,allowshrinking @dagger.Module class *
...
-keep,allowshrinking class * extends android.os.Parcelable$Creator
...
# but it leads to unwanted effects if optimization is disabled for thes
# contructors.
...
-obfuscatecode,high class com.sourcey.materiallogindemo.core.retrofit.RetrofitClient
...
-assumenosideeffects class com.google.android.**
...
-intermediatedirectory, allowoverwrite /Volumes/DATA/DexGuard/applicaiton/demo-apps/academic_ponpes/app/build/outputs/dexguard/bitguard/apk/release
